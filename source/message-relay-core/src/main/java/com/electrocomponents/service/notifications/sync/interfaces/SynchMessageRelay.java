...
public interface SynchMessageRelay {
    
    String EJB_MODULE_NAME = "message-sender-core";

    String SERVICE_NAME = "SynchMessageRelay";
     ...
     */
    BusinessMessage processMessage(final BusinessMessage message);
