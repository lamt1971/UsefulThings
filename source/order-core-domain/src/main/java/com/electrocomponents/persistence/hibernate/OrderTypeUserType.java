...
import com.electrocomponents.model.domain.order.OrderType;
...
/**
 * A hibernate custom user type for mapping {@link OrderType} values.
 */
public class OrderTypeUserType implements UserType {
    ...
    public Object nullSafeGet(final ResultSet rs, final String[] names, SessionImplementor si, final Object owner) throws SQLException {
        ...
        return userType == null ? null : OrderType.value(userType);
    }
    ...
    public void nullSafeSet(final PreparedStatement st, final Object value, final int index, SessionImplementor si) throws SQLException {
        st.setString(index, value == null ? null : ((OrderType) value).getOrderType());
    }
